# <img width="32px" src="./assets/logo.png"/> DONATE BANGLADESH
...
- **Navbar**: Created a visually appealing navbar with the following structure:
...
- **Donation Cards**: Created 3 donation cards with the following details:
  - Image on the left.
  - Donation title.
  - Donation info.
